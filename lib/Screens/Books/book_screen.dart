  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            print("pageController: ${widget.pageController.text}");
                            widget.previousPage();
                          },
                        ),
                        Container(
        ...
        // Fixed "Download Latest File" icon button in the bottom-right corner
        Positioned(
          bottom: 80,
          right: 20,
          child: Visibility(
            visible: fileExists, // Only show when the file exists
            child: GestureDetector(
              onTap: () {
                // Call the method to download the latest file and replace the current file
                startDownload();
              },
              child: Container(
