...
import 'package:e_office/Screens/OtherScreens/affidavit_view.dart';
...
import 'package:e_office/Screens/OtherScreens/auditForm.dart';
import 'package:e_office/Screens/OtherScreens/achivement_view.dart';
...
class _OtherScreenState extends State<OtherScreen> {
  ...
  Future<void> loadUserData() async {
    ...
    setState(() {
      ...
      profileImage = prefs.getString('profile_pic') ?? 'https://eofficess.com/profilephoto/default.jpg'; // Default image URL
    });
  }
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          ...
                          radius: 24,
                          backgroundImage: NetworkImage('https://eofficess.com/profilephoto/$profileImage'), // Prepend the path to the file name
                        ),
